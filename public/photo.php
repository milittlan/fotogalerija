...
<?php if ($session->is_logged_in()) { include_layout_template('user_logged_in_header.php'); } ?>
<?php
...
?>
    ...
    <div style="float:left; margin-left:20px; width: 100%; padding-bottom: 40px;">
    ...
    <a class="btn btn-primary back-button" href="index.php" role="button">Back</a>
